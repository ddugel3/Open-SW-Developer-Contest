...
public class MapActivity extends AppCompatActivity {
    ...
    // 현재 위치 위도 경도
    private double currentLatitude = getIntent().getDoubleExtra("currentLatitude", 0);
    private double currentLongitude = getIntent().getDoubleExtra("currentLongitude", 0);
    ...
    private void searchAndShowLocation(String location) {
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                ...
                CameraUpdate cameraUpdate = CameraUpdate.scrollTo(end);
